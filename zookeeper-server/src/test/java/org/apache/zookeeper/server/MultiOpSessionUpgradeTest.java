...
public class MultiOpSessionUpgradeTest extends QuorumBase {
    ...
    @Test
    public void ephemeralCreateMultiOpTest()
        ...
        try {
            multi = zk.multi(Arrays.asList(
                    ...
                    Op.create(path + "/e", data.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,
                            CreateMode.EPHEMERAL),
                    Op.create(path + "/p", data.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,
                            CreateMode.PERSISTENT),
                    Op.create(path + "/q", data.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,
                            CreateMode.EPHEMERAL)
            ));
    ...
    @Test
    public void directCheckUpgradeSessionTest()
        ...
        Assert.assertNotNull("failed to upgrade on a create",
