...
public class WatcherTest extends ClientBase {
    ...
    public void testWatcherDisconnectOnClose()
        ...
        try {
            ...
            Assert.assertEquals(
                    ...
                    Event.KeeperState.Closed, event.getState());
        } finally {
            if (zk != null) {
                zk.close();
            }
    ...
    public void testWatcherCount()
        ...
        try {
            ...
            Stat stat = new Stat();
            zk1.create("/watch-count-test", "value".getBytes(), Ids.OPEN_ACL_UNSAFE,
                    CreateMode.EPHEMERAL);
            zk1.create("/watch-count-test-2", "value".getBytes(), Ids.OPEN_ACL_UNSAFE,
                    CreateMode.EPHEMERAL);
    ...
    private void testWatcherAutoReset(ZooKeeper zk, MyWatcher globalWatcher,
        ...
        boolean disableAutoWatchReset =
                zk.getClientConfig().getBoolean(ZKClientConfig.DISABLE_AUTO_WATCH_RESET);
