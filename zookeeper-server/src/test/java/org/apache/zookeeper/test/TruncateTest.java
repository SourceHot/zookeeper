...
public class TruncateTest extends ZKTestCase {
    ...
    public void testTruncate() throws Exception {
        ...
        QuorumPeer s2 = new QuorumPeer(peers, dataDir2, dataDir2, port2, 0, 2, tickTime, initLimit,
                syncLimit);
        s2.start();
        QuorumPeer s3 = new QuorumPeer(peers, dataDir3, dataDir3, port3, 0, 3, tickTime, initLimit,
                syncLimit);
        s3.start();
        ...
        QuorumPeer s1 = new QuorumPeer(peers, dataDir1, dataDir1, port1, 0, 1, tickTime, initLimit,
                syncLimit);
        s1.start();
