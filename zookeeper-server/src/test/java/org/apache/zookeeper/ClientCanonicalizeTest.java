...
public class ClientCanonicalizeTest extends ZKTestCase {
    ...
    public void testClientCanonicalization() throws IOException, InterruptedException {
        SaslServerPrincipal.WrapperInetSocketAddress addr =
                mock(SaslServerPrincipal.WrapperInetSocketAddress.class);
        SaslServerPrincipal.WrapperInetAddress ia =
                mock(SaslServerPrincipal.WrapperInetAddress.class);
        ...
        Assert.assertEquals("The computed principal does not appear to have been canonicalized",
